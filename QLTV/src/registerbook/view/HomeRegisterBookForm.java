...
public class HomeRegisterBookForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbtnSeachGiveBookBack.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbtnSeachGiveBookBackActionPerformed(evt);
            }
        });
        ...
        jPanel7.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 80, -1, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel5.setText("Tổng Số Lượng Sách Đang mượn:");
        jPanel7.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, -1, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel6.setText("Tổng Số Lượng Sách còn trong Kho:");
        jPanel7.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 170, -1, -1));

        labelSumBook.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        labelSumBook.setText("*Tổng số Sách");
        jPanel7.add(labelSumBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 80, 210, -1));
        ...
        jPanel7.add(labelSumBorrowBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 120, 250, -1));
        ...
        jPanel7.add(labelRemainingBooks, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 170, 290, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/rsz_thongke.png"))); // NOI18N
        ...
        if (listB.size() > 0) {
            ...
            if (!bookId.isEmpty()) {
                ...
                if (b != null) {
                    ...
                    LabelCheckBookId.setForeground(Color.BLUE);
        ...
        if (listSt.size() > 0) {
            ...
            if (!studentId.isEmpty()) {
                ...
                if (st != null) {
                    ...
                    LabelCheckSTid.setForeground(Color.BLUE);
                } else {
    ...
    private void rbtnSeachGiveBookBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtnSeachGiveBookBackActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbtnSeachGiveBookBackActionPerformed
